...
**US-036:** Как пользователь, я хочу, чтобы мой прогресс по маршруту синхронизировался между устройствами (телефон, планшет) и чтобы я мог продолжить маршрут на другом устройстве с той же версии маршрута, которую я начал, даже если редактор уже опубликовал новую версию, чтобы не потерять свой прогресс и продолжить с того места, где остановился.

**US-037:** Как редактор контента, я хочу иметь возможность исправлять опечатки в названиях и описаниях точек опубликованного маршрута без создания новой версии, чтобы не плодить версии из-за мелких правок, при этом изменения должны быть видны всем пользователям (включая тех, кто уже начал маршрут).

**US-038:** Как редактор контента, я хочу видеть предупреждение в админке, если я пытаюсь добавить или удалить точки в опубликованном маршруте, чтобы понимать, что это создаст новую draft-версию и не повлияет на пользователей, уже проходящих маршрут.

**US-039:** Как контент-менеджер, я хочу постепенно добавлять новые языки к опубликованному маршруту (загружать audio файлы, переводить описания), при этом язык не должен быть виден пользователям до тех пор, пока я не отмечу его как "готовый к публикации", чтобы избежать показа неполного контента.

**US-040:** Как пользователь, я хочу чтобы мой прогресс по маршруту сохранялся локально, когда я прохожу маршрут в offline режиме, и автоматически синхронизировался с сервером при появлении интернета, даже если я проходил один и тот же отрезок несколько раз, чтобы не потерять свой прогресс при отсутствии сети.