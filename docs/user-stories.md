...
1. Платный маршрут НЕ куплен → доступны первые 4 аудио
2. Платный маршрут куплен → доступны все аудио
3. Бесплатный маршрут (price=0) → доступны все аудио
...
2. При публикации Editor указывает, какие языки доступны пользователям
3. Язык виден только если 100% точек переведены И озвучены
4. Новые языки добавляются к последней опубликованной версии
...
*Generated: 2025-12-30 | Conflicts resolved: 2025-12-30 | Updated: 2025-12-30 (US-042, US-043, US-052 added; AC updated)*
